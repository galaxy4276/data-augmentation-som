...
export function TaskNotification({ taskId, taskType, onComplete, onError }: TaskNotificationProps) {
...
export function useTaskNotification() {
  return {
    notifyPending: (taskType: 'extraction' | 'augmentation', taskId: string) => {
      const taskTypeLabels = {
        extraction: '데이터 추출',
        augmentation: '데이터 증강'
      };
    ...
    notifyRunning: (taskType: 'extraction' | 'augmentation', message: string) => {
      const taskTypeLabels = {
        extraction: '데이터 추출',
        augmentation: '데이터 증강'
      };
    ...
    notifyCompleted: (taskType: 'extraction' | 'augmentation', onComplete?: () => void) => {
      const taskTypeLabels = {
        extraction: '데이터 추출',
        augmentation: '데이터 증강'
      };
    ...
    notifyFailed: (taskType: 'extraction' | 'augmentation', error: string, onError?: (error: string) => void) => {
      const taskTypeLabels = {
        extraction: '데이터 추출',
        augmentation: '데이터 증강'
      };
